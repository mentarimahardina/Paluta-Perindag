...
<div class="content">
    <div class="container pt-3">
        <h4 class="mb-sm heading-primary"><strong>Berita</strong></h4>
<!-- 
        <div class="row mb-3">
            <div class="col-md-9"> -->
                <?php
                ...
                $data =  $models->where('post_type', 'post')->where('post_status', 'publish')->findAll();
                $jumlah_data = count($data);
                $total_halaman = ceil($jumlah_data / $batas);

                $data_berita =  $models->where('post_type', 'post')->where('post_status', 'publish')->orderBy('created_at', 'asc')->findAll($batas, $halaman_awal);
                $nomor = $halaman_awal + 1;

                foreach ($data_berita as $key => $item) {
